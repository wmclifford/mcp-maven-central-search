...
This document maps each GitHub Issue to the authoritative section(s) in `PLANNING.md` that define its requirements,
...
| 1.4   | Configuration and settings module           | Configuration (`config.py`)                                                        |
